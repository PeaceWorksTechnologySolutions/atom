...
class ObjectTableMap extends TableMap {
    ...
    $this->addRelation('relationRelatedBysubjectId', 'relation', RelationMap::ONE_TO_MANY, array('id' => 'subject_id', ), 'CASCADE', null);
    $this->addRelation('relationRelatedByobjectId', 'relation', RelationMap::ONE_TO_MANY, array('id' => 'object_id', ), 'CASCADE', null);
