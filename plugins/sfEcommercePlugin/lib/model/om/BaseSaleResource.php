...
abstract class BaseSaleResource implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'sale_resource',

    ID = 'sale_resource.ID',
    SALE_ID = 'sale_resource.SALE_ID',
  ...
  {
    $criteria->addSelectColumn(QubitSaleResource::ID);
    $criteria->addSelectColumn(QubitSaleResource::SALE_ID);
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$saleResources[$key]))
    {
      $saleResource = new QubitSaleResource;

      $saleResource->keys = $keys;
      $saleResource->row = $row;

      $saleResource->new = false;

      self::$saleResources[$key] = $saleResource;
    }

    return self::$saleResources[$key];
  }

  public static function clearCache()
  {
    self::$saleResources = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitSaleResource::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitSaleResource', $options);
  }
  ...
  public static function getById($id, array $options = array())
  {
    ...
    $criteria->add(QubitSaleResource::ID, $id);
  ...
  public static function doDelete(Criteria $criteria, $connection = null)
  {
    if (!isset($connection))
    {
      $connection = QubitTransactionFilter::getConnection(QubitSaleResource::DATABASE_NAME);
    }
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitSaleResource::DATABASE_NAME)->getTable(QubitSaleResource::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitSaleResource::ID, $this->id);
  ...
  {
    $criteria->addJoin(QubitSaleResource::SALE_ID, QubitSale::ID);

    return $criteria;
  }

  public static function addJoinresourceCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitSaleResource::RESOURCE_ID, QubitInformationObject::ID);
  ...
  {
    $criteria->addJoin(QubitSaleResource::REPOSITORY_ID, QubitRepository::ID);
